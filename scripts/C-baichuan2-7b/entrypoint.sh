...
export DEKUBE_MODEL_PATH=/mnt/s3fs/models/Baichuan/Baichuan2-7B-Base
...
cp /mnt/s3fs/scripts/C-baichuan2-7b/fine-tune.py ${iRESULTwrk}
cp /mnt/s3fs/scripts/C-baichuan2-7b/ds_config.json ${iRESULTwrk}
cd ${iRESULTwrk}
