...
export DEKUBE_MODEL_PATH=/mnt/s3fs/models/CodeLlama/CodeLlama-34b-Instruct-hf
...
cp /mnt/s3fs/scripts/C-codellama-34b/llama2-finetune.py ${iRESULTwrk}
cd ${iRESULTwrk}
