...
if __name__ == "__main__":
    ...
    # d = datasets.load_dataset("json", data_files="databricks-dolly-15k.jsonl", split="train")
    dataset = datasets.load_dataset("json", data_files=f"{datasetpath}", split="train")
    ...
    max_steps = int(os.getenv("MAX_STEPS", -1)) # positive value will override num_train_epochs
    num_train_epochs = int(os.getenv("NUM_TRAIN_EPOCHS", 1))
    gradient_accumulation_steps = int(os.getenv("GRADIENT_ACCUMULATION_STEPS", 4))
    train(model, tokenizer, dataset, output_dir, max_steps, num_train_epochs, gradient_accumulation_steps)
