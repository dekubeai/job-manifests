...
export DEKUBE_DATASET_PATH=/mnt/dekube/datasets/databricks-dolly-15k-modified.json
export DEKUBE_MODEL_PATH=/mnt/dekube/models/Baichuan/Baichuan2-13B-Base
...
cp /mnt/dekube/scripts/A-baichuan2-13b/fine-tune.py ${iRESULTwrk}
cp /mnt/dekube/scripts/A-baichuan2-13b/ds_config.json ${iRESULTwrk}
cd ${iRESULTwrk}
