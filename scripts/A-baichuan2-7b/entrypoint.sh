...
export DEKUBE_MODEL_PATH=/mnt/dekube/models/Baichuan/Baichuan2-7B-Base
...
cp /mnt/dekube/scripts/A-baichuan2-7b/fine-tune.py ${iRESULTwrk}
cp /mnt/dekube/scripts/A-baichuan2-7b/ds_config.json ${iRESULTwrk}
cd ${iRESULTwrk}
