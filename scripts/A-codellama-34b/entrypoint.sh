...
export DEKUBE_MODEL_PATH=/mnt/dekube/models/CodeLlama/CodeLlama-34b-Instruct-hf
...
cp /mnt/dekube/scripts/A-codellama-34b/llama2-finetune.py ${iRESULTwrk}
cd ${iRESULTwrk}
