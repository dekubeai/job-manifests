...
export DEKUBE_MODEL_PATH=/mnt/dekube/models/LLAMA2/metaAi/Llama-2-70b-chat-hf
...
cp /mnt/dekube/scripts/A-llama2-70b/llama2-finetune.py ${iRESULTwrk}
cd ${iRESULTwrk}
